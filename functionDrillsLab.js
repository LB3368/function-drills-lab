...
let nameGreeting = nameCheck('Theresa')
...
//CODE HERE
console.log(`I used Math.Floor in my previous question so I didn't get a decimal`)
function chocolateFrogs(gold) {
  return Math.floor(gold / 3)
}
let totalFrogs2 = chocolateFrogs(2)
...
let array = [0, 10, 20, 25, 42, 50, 66, 79, 90]
let arrayAscending = arrayIsAscending(array)
